...
export default function Header({setShowAddPostModal}) {
  return (
    <div className="sticky top-0 border">
      <div className="max-w-935px mx-auto flex justify-between items-center h-14 px-3">
        <img className="my-auto h-7 " alt='logo' src='/instaLogo.png' />
        <div>
          <div className='cursor-pointer' onClick={()=>setShowAddPostModal(true)}>
            <svg aria-label="New Post" className="_8-yf5 " fill="#262626" height="24" role="img" viewBox="0 0 48 48" width="24">
